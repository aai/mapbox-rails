...
class RemoteResourceLoader < Thor
  ...
  def convert
    ...
    inside destination_root do
      ...
      gsub_file 'stylesheets/mapbox.css.scss', 'url(images/layers-2x.png)',       "image-url('layers-2x.png')"
      gsub_file 'stylesheets/mapbox.css.scss', 'url(images/marker-icon.png)',     "image-url('marker-icon.png')"
      gsub_file 'stylesheets/mapbox.css.scss', 'url(images/marker-icon-2x.png)',  "image-url('marker-icon-2x.png')"
      gsub_file 'stylesheets/mapbox.css.scss', 'url(images/marker-shadow.png)',   "image-url('marker-shadow.png')"
      gsub_file 'stylesheets/mapbox.css.scss', 'url(images/icons-000000@2x.png)', "image-url('icons-000000@2x.png')"
      gsub_file 'stylesheets/mapbox.css.scss', 'url(images/icons-ffffff@2x.png)', "image-url('icons-ffffff@2x.png')"
    end
  end
